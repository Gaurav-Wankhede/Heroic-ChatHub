...
import { BaseLanguageModelInput, type LanguageModelLike } from "@langchain/core/language_models/base";
...
export const useModelList = () => {
    ...
    switch (model.baseModel) {
      ...
      case "gemini":
        const geminiModel = new ChatGoogleGenerativeAI({
          ...
          topP,
          topK,
        }) as ChatGoogleGenerativeAI & { bindTools: (tools: any[], options: any) => any };

        // Add tool binding capability
        geminiModel.bindTools = (tools: any[], options: any) => {
          return geminiModel.bind({
            ...options,
            tools,
          });
        };
  ...
  const models: TModel[] = [
    ...
    },
    {
      ...
      key: "gemini-2.0-flash-thinking-exp-1219",
      tokens: 32000,
      isNew: true,
      plugins: ["web_search", "image_generation", "memory"],
